...
func _ready():
	refresh_palettes()
	refresh_list_button.connect("pressed", refresh_palettes)
	apply_color_changed_button.connect("pressed", _apply_new_color_to_selected_palette)
	new_palette_button.connect("pressed", _create_new_palette)
	color_picker.connect("color_changed", new_color_rect.set_color)
	new_color_button.connect("pressed", _add_color_to_selected_palette)
	open_palette_dir_button.connect("pressed", _open_dir_in_file_manager)
...
#	Ensure trailing slash
	...
	for p in palettes:
		...
		pc.connect("palette_updated", refresh_palettes)
		pc.connect("palette_color_selected", _on_palette_color_selected)
		pc.connect("container_selected", _on_palette_container_selected)
